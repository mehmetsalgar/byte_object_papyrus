...
public class MyBenchmarkOrdersByteBuffer extends AbstractBenchmark {
    private static final Logger log = Logger.getLogger(MyBenchmarkOrdersByteBuffer.class);
    ...
    public static class MySetupOrders {
        ...
        public void initialize() {
            ...
            //byteBuffer = ByteBuffer.allocateDirect(orders.calculateLength());
            byteBuffer = ByteBuffer.allocate(orders.calculateLength());
        }
    }
    ...
    public void testMethod(MySetupOrders setup) {
        int length = serialize(setup.orders, setup.byteBuffer);
        //log.info("length: " + length) ;
    }

    int serialize(Orders orders, ByteBuffer byteBuffer) {
        //byte[] serializedBytes =
        byteBuffer.clear();
        orders.toByte(byteBuffer);
